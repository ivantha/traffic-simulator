...
public class TrafficLightFunction {
    public void setNorthLane1Traffic(TrafficLight.State state){
        Session.getNorthLane1TrafficLight().setState(state);
    }

    public void setNorthLane2Traffic(TrafficLight.State state){
        Session.getNorthLane2TrafficLight().setState(state);
    }

    public void setNorthLane3Traffic(TrafficLight.State state){
        Session.getNorthLane3TrafficLight().setState(state);
    }

    public void setEastLane1Traffic(TrafficLight.State state){
        Session.getEastLane1TrafficLight().setState(state);
    }

    public void setEastLane2Traffic(TrafficLight.State state){
        Session.getEastLane2TrafficLight().setState(state);
    }

    public void setEastLane3Traffic(TrafficLight.State state){
        Session.getEastLane3TrafficLight().setState(state);
    }

    public void setSouthLane1Traffic(TrafficLight.State state){
        Session.getSouthLane1TrafficLight().setState(state);
    }

    public void setSouthLane2Traffic(TrafficLight.State state){
        Session.getSouthLane2TrafficLight().setState(state);
    }

    public void setSouthLane3Traffic(TrafficLight.State state){
        Session.getSouthLane3TrafficLight().setState(state);
    }

    public void setWestLane1Traffic(TrafficLight.State state){
        Session.getWestLane1TrafficLight().setState(state);
    }

    public void setWestLane2Traffic(TrafficLight.State state){
        Session.getWestLane2TrafficLight().setState(state);
    }

    public void setWestLane3Traffic(TrafficLight.State state){
